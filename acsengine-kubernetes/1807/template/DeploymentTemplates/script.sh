...
INSTALL_SCRIPT_URL="https://raw.githubusercontent.com/deaborch/azurestack-gallery/master/acsengine-kubernetes/1807/template/DeploymentTemplates/install.py"
...
echo "Cloning the ACS-Engine repo/branch: deaborch, acs-engine-v0189"
git clone https://github.com/deaborch/acs-engine -b acs-engine-v0189
cd acs-engine
