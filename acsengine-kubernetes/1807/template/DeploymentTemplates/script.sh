...
INSTALL_SCRIPT_URL="https://raw.githubusercontent.com/msazurestackworkloads/azurestack-gallery/master/acsengine-kubernetes/1807/template/DeploymentTemplates/install.py"
...
echo "Cloning the ACS-Engine repo/branch: msazurestackworkloads, acs-engine-v0189"
git clone https://github.com/msazurestackworkloads/acs-engine -b acs-engine-v0189
cd acs-engine
