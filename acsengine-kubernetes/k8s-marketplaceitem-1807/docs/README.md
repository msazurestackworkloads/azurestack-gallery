...
1) Modifed ACS-Engine repo: 
	https://github.com/deaborch/acs-engine/tree/acs-engine-v0189-1807

2) Linux binary: 
	https://github.com/deaborch/acs-engine/tree/acs-engine-v0189-1807/examples/azurestack/acs-engine.tgz

3) Example of working JSON (API model): 
	https://github.com/deaborch/acs-engine/tree/acs-engine-v0189-1807/examples/azurestack/azurestack-kubernetes1.10.json
