...
echo "Cloning the ACS-Engine repo/branch: msazurestackworkloads, acs-engine-v0209"
git clone https://github.com/msazurestackworkloads/acs-engine -b acs-engine-v0209
cd acs-engine
